  ...
  return (
    <div>
      <div className="flex gap-10 justify-center">
        <div className="w-2/4 border-2 h-[250px] rounded-3xl">
          <h1 className="m-4 text-3xl text-start">
          ...
          <div className="flex ml-8 ">
            <img
              src="/images/0bbab93269310c5391b5da608c718a40.jpg"
              className="w-14 h-14"
            ></img>
            <h1 className="font-bold text-xl mt-4 ml-2">Lee Munroe-</h1>
            <h1 className="text-xl mt-4 ">Head of design,OneSignal</h1>
          </div>
        </div>
        <div className="w-1/4 h-[250px] border-2 rounded-3xl bg-gradient-to-br from-pink-400 to-yellow-200 via-red-400 text-white">
          <div className="flex justify-center mt-16 rolling-svg-container  ">
            <svg
      ...
      <div className="flex justify-center mt-16 mb-16 ">
        <h1 className="text-6xl font-medium w-3/5 text-center">
      ...
      <div className="flex m-8 ">
        <div className="w-2/4">
          <div className="m-4 w-4/6">
            ...
            <h3 className="mt-2 mb-2 font-bold text-xl bg-blue-100 w-44">
              World-class talent
            </h3>
            <p>
          ...
          <div className="m-4 mt-6 mb-6 w-4/6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
            ...
            <h3 className="mt-2 mb-2 font-bold text-xl bg-[#e3ebfd] w-44">
              $0 placement fees
            </h3>
            <p>
          ...
          <div className="m-4 w-4/6">
            ...
            <h3 className="mt-2 mb-2 font-bold text-xl bg-[#edddfb] w-32">
              Global reach
            </h3>
            <p>
        ...
        <div className="w-2/4">
          <img
            src="/images/11a557ca1a5c49c9bcd89a22f781d953.jpg"
            className="rounded-3xl h-[90%]"
          />
        </div>
      </div>

      <h1 className="ml-10 text-5xl font-medium" >Plus, top quality work</h1>
        
        
        <div className="container grid-flow-row" >
        <div className="flex gap-2 flex-wrap" >
        <img src="/images/cd929a56af76f436c8759841407a6e48.jpg" />
        <img src="/images/0634279dac13fff2153e022355de7cf1.jpg"/>
        <img src="/images/03e8d463fa0122f2cf09bc3a705163b1.jpg"/>
        <img src="/images/54fbc96badf2dd56aeff1d055d1d3479.jpg"/>
        </div>
        </div>


        <div className="flex w-4/5 gap-10 p-10 ml-24" >
            <div className=" bg-gray-100 rounded-3xl w-3/4" >
                <div className="m-10" >  
                <h1 className="bg-[#b3fbe3] w-36 m-4 text-center rounded-3xl h-10 font-medium items-center justify-center flex" >Looking for work?</h1>
                <h1 className="m-4 text-5xl" >Find your next opportunity</h1>
                <p className="m-4 text-xl" >Browse new design jobs or boost your portfolio to get discovered.</p>
                <div className="flex m-4 gap-10" >
                <button className="bg-[#0d0c22] text-white w-28  rounded-3xl h-12" >Find Work</button>
                <button  className="bg-white w-36 rounded-3xl text-lg" >Get discovered</button>
                </div>
                </div>
            </div>
            ...
            <div className=" bg-gray-100 rounded-3xl w-3/4" >
                <div className="m-10" >
                <h1 className="bg-[#ffabe7] w-44 m-4 text-center rounded-3xl h-10 font-medium items-center justify-center flex" >Here for inspiration?</h1>
                <h1 className="m-4 text-5xl" >Discover trending designs</h1>
                <p className="m-4 text-xl" >Browse and save your favorite design projects for endless inspiration.</p>
                <div className="flex m-4 gap-10" >
                <button className="bg-[#0d0c22] text-white w-36  rounded-3xl h-12" >Creat my profile</button>
                <button className="bg-white w-36 rounded-3xl text-lg" >Browse designs</button>
                </div>
                </div>
            </div>
        ...
        <div className="bg-[#ffda79] h-[500px]" >
            <div className="p-6"  >
            <h1 className="flex justify-center mt-28 text-7xl font-medium" >Start hiring today</h1>
            </div>
            <p  className="flex justify-center text-xl m-4" >Browse Prtfolios and engage with the top creative talent today.</p>
            <div className="flex gap-10 justify-center m-6" >
                <button className="bg-[#0d0c22] text-white w-40  rounded-full h-14" >Get started now</button>
                <button  className="bg-white w-44 rounded-full h-14 text-lg" >Learn about hiring</button>
                </div>
                <div className="flex justify-center text-xl" >
                    <p>Are you a designer?</p>
                    <a href="" className="underline" >Join Dribbble</a>
                </div>
